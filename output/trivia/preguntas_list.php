...
{
  print( '<div><a class="pure-button" type="button" href="preguntas_form.php">Nuevo</a><a class="pure-button" type="button" href="preguntas_compile.php">Compile</a></div>' );
...
//  print( '</thead><tbody>' );
  ...
  foreach( $array as $row => $cells )
  {
    ...
    print( '</td><td><a class="pure-button" href="preguntas_form.php?id='.$row.'">Editar</a></td></tr>' );*/
    print( "<tr><th>$row</th>" );
    foreach($header as $h){
      print( '<td>'.@$cellsH[$h].'</td>' );
    }
    print( '<td><a class="pure-button" href="preguntas_form.php?id='.$row.'">Editar</a></td></tr>' );
  }
  print( '</tbody></table>' );
}
